      ...
      <div className="bg-white rounded-[40px] shadow-xl border border-slate-100 overflow-hidden">
        <Table>
          ...
          <TableBody>
            {loading ? (
              <TableRow>
                <TableCell colSpan="4" className="p-12 text-center flex justify-center"><LoadingSpinner /></TableCell>
              </TableRow>
            ) : filteredPermissions.length === 0 ? (
              <TableRow>
                <TableCell colSpan="4" className="p-12 text-center text-slate-400 italic">No matching protection protocols found.</TableCell>
              </TableRow>
            ) : (
