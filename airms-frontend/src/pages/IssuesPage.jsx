    ...
    <div className="max-w-[1600px] mx-auto space-y-10 py-10 px-6">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-12 gap-10">
        ...
        <div className="xl:col-span-4">
           <Card className="rounded-[40px] border-none shadow-2xl bg-white overflow-hidden ring-1 ring-slate-100 sticky top-32">
             <div className="p-8 bg-red-50/30 border-b border-red-50">
               <div className="flex items-center gap-4">
                  ...
                  <div>
                     <h4 className="text-lg font-black text-slate-900 uppercase tracking-tight leading-none mb-1">Report a Problem</h4>
                     <p className="text-[10px] font-bold text-slate-500 leading-relaxed uppercase opacity-80">Log a new system incident.</p>
                  </div>
               </div>
             </div>
             <CardContent className="p-8 space-y-6">
                <div className="space-y-2">
                   <label className="text-[10px] font-black text-slate-500 uppercase tracking-widest ml-1 text-right">Issue Title</label>
                   <Input 
                     placeholder="A short title for the problem..." 
                     value={formData.title} 
                     onChange={(e) => setFormData({ ...formData, title: e.target.value })} 
                     className="h-14 rounded-2xl border-2 border-slate-50 font-black text-slate-900 focus:border-blue-500"
                   />
                </div>

                <div className="space-y-2">
                   <label className="text-[10px] font-black text-slate-500 uppercase tracking-widest ml-1">Related Item (Optional)</label>
                   <select 
                     className="w-full h-14 bg-slate-50/50 border-2 border-slate-50 rounded-2xl px-4 font-bold outline-none focus:border-blue-500"
                ...
                <div className="space-y-2">
                   ...
                   <textarea 
                     ...
                     placeholder="Please describe exactly what happened and how we can see the problem..."
                ...
                <Button 
                   ...
                   loading={submitting}
                   className="w-full h-16 rounded-2xl bg-slate-900 hover:bg-blue-600 text-white font-black uppercase tracking-widest shadow-xl"
                >
                   Submit Report
                </Button>
             </CardContent>
        ...
        <div className="xl:col-span-8 space-y-6">
          <div className="flex items-center gap-2 mb-2 px-2">
            ...
            <h3 className="font-black text-slate-400 text-[10px] uppercase tracking-[0.3em]">Incident History</h3>
          </div>
